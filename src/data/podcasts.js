export const podcasts = [
{
    ...
    "content": [
        {
            "type": "paragraph",
            "text": "Bienvenidos y bienvenidas a este nuevo anlisis a fondo. Eh, la verdad es que es un placer tener a la audiencia acompandonos hoy para adentrarnos en un tema que, sinceramente, mmm, est transformando por completo el mundo del anlisis de datos. Hola. S, es un cambio brutal. Hoy centramos nuestra inmersin en un concepto muy potente de los materiales que estamos analizando. Es la sesin titulada De cero a giro. Un ttulo muy, muy acertado para lo que vamos a ver. Y la premisa que vamos a manejar es fascinante. Vamos a hablar de una herramienta que parece absoluta magia, pero que esconde un pequeo gran secreto. Hablamos de Copilot integrado en Power BI. Eso es. Porque cuando lo ves en accin por primera vez, eh, generando grficos complejos y escribiendo cdigo en cuestin de segundos, la sensacin general es que, bueno, que el trabajo duro ya est hecho. Ya, es la trampa visual. Exacto. Pero la cruda realidad es que esta inteligencia artificial puede alucinar, puede equivocarse por completo y llevarnos por el camino equivocado. Totalmente. Y a ver, es un arma de doble filo, porque presenta un potencial inmenso para acelerar tareas cotidianas, pero precisamente por esa velocidad y esa aparente seguridad con la que responde, pues requiere un nivel de vigilancia mucho mayor por parte de quien est a los mandos. Mmm. Asumir que es un orculo infalible de verdad es el primer gran error que se comete en el anlisis moderno. Y por eso, para quienes nos escuchan hoy, nuestra misin en este episodio es comprender cmo est evolucionando radicalmente el rol de la persona que analiza datos. S. La idea de ser un simple creador que empieza con un lienzo en blanco y va construyendo poco a poco, eh, eso est quedando atrs. Atrs del todo. El nuevo perfil indispensable es el de un editor experto. La verdadera maestra hoy en da no es sentarse con los brazos cruzados a mirar cmo la mquina hace todo el trabajo. Ojal fuera as de fcil. Claro. La maestra reside en saber exactamente cmo guiarla, cmo darle las instrucciones precisas para lograr resultados que antes parecan imposibles. Es un salto cualitativo enorme en la forma de trabajar, porque implica pasar de la pura ejecucin mecnica de picar cdigo durante horas y horas a una supervisin completamente estratgica. Mmm. Quien domina los datos ahora, francamente, debe dominar la comunicacin con la mquina. Vale, vamos a desgranar esto, porque la diferencia entre escribir cdigo desde cero, lnea por lnea, y supervisar a una inteligencia artificial me parece abismal a nivel prctico. Eh, cmo se materializa realmente este cambio en el da a da de un equipo de trabajo? Pues a ver, el concepto fundamental que hay que entender aqu es que los resultados que ofrece Copilot son de naturaleza no determinista. Vale. En la programacin clsica a la que estamos acostumbrados, si se introduce la misma frmula de clculo diez veces, eh, se obtiene matemticamente el mismo resultado diez veces. Es cien por cien predecible. Exacto, cien por cien. Sin embargo, los modelos de lenguaje natural que impulsan esta inteligencia artificial funcionan de otra manera. Interpretan el contexto y generan una respuesta probabilstica. Ya. Eso significa que una misma indicacin o un mismo prompt puede generar respuestas ligeramente diferentes si se hace en distintas sesiones o con un contexto previo distinto. Para un momento, porque esto me parece crtico. Si los resultados son probabilsticos, eh, imaginemos un escenario real. Venga. Un equipo de ventas de una cadena de tiendas de electrnica. Si alguien en el departamento financiero pide un informe sobre la campaa de Black Friday un martes y otra persona hace exactamente la misma pregunta a la IA el jueves, me ests diciendo que el grfico o los datos podran ser distintos? Podran presentar variaciones, s. Variaciones en la forma en que estructuran la respuesta o los filtros sutiles que aplican si el modelo de datos no est perfectamente atado. Madre ma. Y ah radica la necesidad absoluta de cambiar la mentalidad hacia la de un editor experto. El caos puede ser monumental si no hay una auditora constante. Claro, te fas y luego los nmeros no cuadran en la reunin. Tal cual. El trabajo tcnico ms pesado, como la redaccin de grandes bloques de cdigo o el diseo del esqueleto visual del informe, efectivamente se traslada a la inteligencia artificial. Pero hay algo intransferible. El qu? La responsabilidad de la veracidad. Copilot reduce docenas de horas de esfuerzo manual a unos pocos minutos, pero exige a cambio un pensamiento crtico muchsimo ms agudo para evitar narrativas incorrectas o clculos que parezcan correctos pero sean engaosos en el fondo. Fjate, me pregunto si hay alguna forma de visualizar este cambio de rol sin ponernos demasiado tcnicos. Cmo explicaras esta transicin de creador a editor para alguien que acaba de aterrizar en este mundo? Pues imagina un estudio de grabacin musical. Vale. El analista tradicional era la persona que tocaba todos y cada uno de los instrumentos. Grababa la batera, luego el bajo, luego la guitarra, pista por pista. Mucho tiempo invertido ah. Muchsimo. Llevaba muchsimo tiempo. El analista moderno, el editor experto, es ms bien quien dirige una orquesta sinfnica. Ah, me gusta esa imagen. La orquesta, que representa a la IA, tiene una potencia brutal, un virtuosismo tcnico increble y puede tocar cualquier partitura al instante. Pero la orquesta no tiene visin de conjunto. Ya. Si quien dirige no sabe marcar el tempo correcto o no tiene el odo entrenado para detectar que la seccin de vientos est ligeramente desafinada, el resultado final ser un desastre ruidoso. Por muy rpido que hayan tocado. Exactamente. Quien dirige no toca el instrumento, pero es el responsable ltimo de que la sinfona tenga sentido. Y aqu es donde la cosa se pone realmente interesante, porque para poder dirigir esa orquesta y detectar esos instrumentos desafinados, supongo que el primer paso indiscutible es conocer las limitaciones del propio auditorio. Hay cosas que la inteligencia artificial sencillamente no puede hacer, por muy mgica que parezca. As es. Y debemos dividir esas limitaciones en varios frentes muy claros para no llevarnos sorpresas. En primer lugar estn los lmites puramente analticos. Vale.Existe una creencia muy extendida y muy peligrosa de que Copilot tiene una especie de consciencia del negocio. No la tiene. No puede generar percepciones profundas o deducciones causales de la nada. Es decir, si vuelvo a nuestro ejemplo de la tienda de electrnica y le pregunto a la IA: Oye, por qu bajaron nuestras ventas de televisores en julio? Qu ocurre? Se inventa una respuesta? Fracasar estrepitosamente. Te dir que las ventas bajaron un 15 %, que es un dato que puede leer en la tabla, pero no te dir el porqu. Claro. No puede realizar detecciones de anomalas complejas o pronsticos sin que haya un modelo de machine learning externo que haya sido configurado y entrenado especficamente para ese propsito. No lee la mente del mercado. Para nada. La IA generativa lee lo que ya existe en el modelo semntico, cruza variables basndose en probabilidades lingsticas, pero no tiene intuicin comercial, no adivina el comportamiento del mercado ni sabe que en julio hubo una ola de calor que vaci las calles. Queda claro que no es un consultor de estrategia empresarial encubierto. Desde luego que no. Y qu pasa con las barreras de entrada? Porque a veces parece que cualquiera puede abrir su ordenador porttil en la cafetera y empezar a pedirle a Copilot que analice millones de datos gratis. Esa es otra barrera fundamental: las limitaciones tcnicas y de capacidad. Aj. La inteligencia artificial generativa requiere una potencia de clculo gigantesca en los servidores. Opera a travs de una demanda altsima de GPUs en la nube. Por este motivo, esto no es algo que funcione en versiones de prueba gratuitas o en entornos de aprendizaje bsicos. Ya. No vale con la cuenta gratuita. [chasquido de lengua] No, requiere una capacidad organizacional dedicada y de pago. He escuchado trminos tcnicos volando por ah cuando se habla de requisitos como Fabric F64. Si tuvieras que explicarle a alguien sin un perfil tcnico qu significa necesitar un F64 o un Premium P1, cmo lo haras? Piensa en ello como el motor de un vehculo pesado. Un entorno bsico de Power BI es como un coche utilitario. Es perfecto para ir al trabajo y llevar informes normales. S. Pero pedirle a una inteligencia artificial que procese lenguaje natural, entienda bases de datos masivas y devuelva cdigo en segundos requiere el motor de un tren de mercancas. Entendido. Esa capacidad F64 es bsicamente alquilar una porcin considerable de un superordenador en la nube de forma constante. Es una inversin estructural seria para una empresa, no un simple botn que se enciende en cualquier cuenta de usuario. Vale, entiendo que la infraestructura debe ser muy robusta, pero incluso teniendo ese superordenador, los datos en s mismos tambin tienen topes, verdad? Tienen lmites muy estrictos de volumen que el editor experto debe saberse de memoria para no frustrarse. Cuntame. Tomemos la funcin de resumen narrativo, donde Copilot lee un grfico y redacta un prrafo explicando lo ms destacado. Muy til para las presentaciones. S, pero esa funcin especfica solo opera correctamente si el grfico visual en pantalla contiene menos de treinta mil filas de datos en su estructura interna. Treinta mil filas. Y eso es mucho o poco en la realidad de las empresas? En el mundo de los datos empresariales, treinta mil filas es poqusimo. Es casi nada. Y se vuelve ms crtico an si lo que ests analizando es una matriz, una de esas tablas cruzadas tpicas. El lmite cae a apenas quinientas filas. Quinientas filas. Pero vamos a ver, eso lo superas cruzando clientes y productos en cualquier tienda de barrio. Totalmente. Qu pasa cuando la matriz tiene seiscientas filas? La pantalla se congela o lanza un mensaje de error gigante en rojo? Ese es precisamente el mayor peligro. A menudo, no lanza un error catastrfico que te detenga. Ah, no? No. Lo que hace es ignorar el contexto visual especfico de ese grfico que queras resumir. Al verse desbordado por las filas, abandona el grfico y pasa a leer el modelo semntico general que hay por detrs. Ostras. As que la respuesta que genera en texto deja de estar enfocada en la matriz que el usuario est mirando y pasa a ser una respuesta generalizada sobre toda la base de datos. Qu peligro. Quien lee el informe puede acabar tomando decisiones creyendo que el resumen habla de un segmento concreto, cuando en realidad la I est generalizando a ciegas. Exacto. Toma decisiones basadas en una alucinacin por desbordamiento de datos. Eso suena a una receta perfecta para el desastre en una reunin de directivos. Y por si fuera poco lidiar con esos lmites, tengo entendido que hay un reloj de arena que ya se ha dado la vuelta. S, hay una fecha lmite. Hay un horizonte, diciembre de 2026, que va a forzar a todo el mundo a adaptarse a esto, lo quieran o no. Si conectamos esto con la perspectiva general de la plataforma y hacia dnde se dirige la tecnologa, esa fecha es el punto de no retorno. A ver. En diciembre de 2026, la antigua funcin de preguntas y respuestas, el Q&A clsico que ha estado en Power BI durante aos, se retirar por completo y dejar de funcionar. Para quienes llevan tiempo usando la herramienta y estn acostumbrados a escribir en esa barrita antigua para buscar un dato, qu es exactamente lo que se pierde y qu es lo que se gana con este apagn? Pues el Q&A clsico funcionaba con esquemas lingsticos tradicionales. Bsicamente, la herramienta buscaba palabras clave exactas en los nombres de las columnas. Si escribas ventas, buscaba la columna llamada ventas. Era muy literal. Era un sistema muy rgido. Al migrar al nuevo formato de Copilot, se activan los ndices generativos. Esto significa que la IA pasa a comprender el lenguaje humano, los sinnimos complejos y la intencin detrs de la pregunta, respondiendo de forma muchsimo ms dinmica. Eso suena bien. Suena genial, pero el problema es que esta migracin es manual en muchos aspectos.Los equipos de anlisis tienen que actualizar y revisar sus modelos de datos hoy mismo para encajar en la nueva arquitectura generativa. Quien llegue a diciembre de 2026 sin haber hecho los deberes, se encontrar con que todos sus reportes antiguos que dependan de esa barra de bsqueda simplemente se rompern. Quedarn totalmente obsoletos. Inservibles. Entonces, qu significa todo esto? Tenemos respuestas probabilsticas que cambian inversiones en servidores pesados, topes de quinientas filas en matrices y un apagn en 2026. Un panorama intenso. La pregunta del milln es: cmo pasamos a la accin sin estrellarnos? Cmo preparamos los datos para que esta orquesta suene bien y la IA no se ponga a alucinar mtricas falsas? El trabajo de un verdadero editor experto comienza mucho antes de hacerle la primera pregunta a la IA. Todo se fundamenta en un flujo de trabajo que se conoce internamente como preparar datos para ella. Vale. Es un proceso sistemtico que tiene tres pilares esenciales. El primero de ellos es simplificar el esquema de los datos. He escuchado que a los modelos de datos a veces les sobra ruido tcnico. Qu significa esto exactamente y por qu molesta tanto a Copilot? Piensa otra vez en la base de datos de nuestra cadena de electrnica. A nivel tcnico, para que los sistemas funcionen bien, los ingenieros de datos crean cosas como claves subrogadas. Eso qu es? Son nmeros de identificacin largusimos sin ningn significado humano. O tambin crean tablas puente, que solo sirven para conectar unas tablas con otras, pero no contienen informacin real de negocio. Vale, engranajes internos. Exacto. Si dejas todo eso visible en el modelo, la IA intentar leerlo, se distraer analizando cdigos alfanumricos irrelevantes y perder muchsima capacidad de procesamiento. Claro, se la. Simplificar el esquema significa ocultar visualmente todos esos engranajes del motor. Solo hay que dejar expuestas las columnas y tablas que una persona normal usara para hablar de su negocio: nombres de clientes, fechas, ubicaciones y facturacin. Es como limpiar la habitacin antes de que entre la visita. Me parece de lo ms lgico. Cul sera el segundo pilar de esta preparacin previa? La redaccin explcita de instrucciones de IA. Aj. Hay que definir las reglas de negocio, porque, de nuevo, la IA no tiene instinto. Si un analista puede ver las compras de los clientes VIP, la herramienta no tiene ni idea de qu significa VIP en esa empresa especfica. Cierto. Podra ser alguien que compra mucho volumen o alguien que lleva diez aos registrado. Claro. En una tienda de coches de lujo, un VIP puede ser alguien que compr una sola vez hace un mes, pero en nuestra tienda de electrnica podra ser alguien que viene todas las semanas a comprar cables. Exactamente. En estas instrucciones se introducen directrices escritas donde se le explica a la mquina: Atencin, cuando un usuario pregunte por clientes VIP, debes aplicar un filtro en la tabla de clientes y devolver nicamente aquellos que han gastado ms de diez mil euros en el ao en curso. Lo dejas por escrito. Al hacer esto, eliminas la ambigedad de un plumazo y reduces la probabilidad de que la IA invente su propia definicin. Bsicamente, le pones barreras al comportamiento no determinista del que hablbamos al principio. Eso es. Y el tercer pilar creo que es el escudo definitivo para curarse en salud con los datos ms crticos, no? As es. Hablamos de las respuestas verificadas. Cuntanos sobre esto. En toda empresa hay ciertas preguntas, como el margen de beneficio trimestral o la liquidez en caja, donde el margen de error sencillamente debe ser cero. No se permite ni un gramo de creatividad. Con el dinero no se juega. Exacto. Para estas mtricas intocables, el editor experto preconfigura grficos exactos. Cuando el director financiero entra y pregunta: Oye, cul es el margen de este mes?. La IA reconoce la pregunta crtica. Vale. Y puentea todo el proceso de generacin dinmica. En su lugar, devuelve el grfico cerrado y preaprobado por el equipo de datos. Es brillante. Es como decirle a la IA: Oye, puedes ser muy creativa con las tendencias generales de marketing, pero si te preguntan por el dinero que queda en el banco, lee esta tarjeta y no te desves ni un milmetro. Es la mxima expresin de gobernar a la mquina. Pero por supuesto, gran parte del trabajo diario no est tan encorsetado. Y ah es donde entra en juego el arte puramente humano de la interaccin directa, el famoso prompting. El prompting. Saber cmo pedir las cosas altera drsticamente la calidad de lo que recibes. Esto me interesa mucho. Si yo me siento frente a la pantalla y le lanzo un prompt un poco vago. Por ejemplo: Oye, Copilot, mustrame las ventas de Navidad. Qu acaba haciendo la herramienta? Pues entrar en pnico probabilstico. Se preguntar: qu son ventas? Ingresos brutos o netos? Qu es Navidad? Diciembre entero o solo la ltima semana del ao? Har suposiciones. Terminar lanzando un grfico con la opcin que considere ms probable estadsticamente, pero que seguramente no sea lo que t queras. Un verdadero editor experto huye de la vaguedad. Hay que ser muy especfico. La especificidad lo es todo. Un buen prompt en ese caso sera: Genera una consulta que enumere el nombre de los productos con ingresos netos superiores a cero durante los meses de noviembre y diciembre. Incluye una columna con el margen de beneficio porcentual y ordena el resultado de forma descendente por ingresos. Vaya, no tiene absolutamente nada que ver. Es casi como redactar un contrato legal para asegurarse de que no haya ninguna laguna. Y hay que usar los trminos comerciales exactos que existen en las columnas del modelo. Y adems, hay un secreto que mucha gente pasa por alto. Cul? La configuracin de sinnimos en el modelo de datos. Ah, los sinnimos. Si en las reuniones de la oficina todo el mundo llama beneficio limpio al margen neto, ese sinnimo, beneficio limpio, tiene que estar registrado internamente. Si no, la IA buscar una columna que no existe. Adems, te dir que el prompting es iterativo. No sale a la primera. Rara vez. No se busca el cdigo perfecto a la primera. Se pide una base, se revisa y luego se le pide que aada un filtro o cambie un color. Es, en esencia, una conversacin. Una conversacin tcnica continua.Y hablando de tcnica pura y dura, todo esto nos lleva al corazn absoluto de la herramienta, el motor bajo el cap que mueve toda la analtica: el lenguaje DAX. S, el temido DAX. S que aqu es donde mucha gente sufre, porque escribir estas frmulas tan complejas lleva muchsimo tiempo. Cmo interviene Copilot especficamente en este terreno para alguien que audita datos? Lo fascinante de esto es cmo se ha integrado la experiencia visual. Hay un atajo de teclado que se convierte enseguida en el mejor amigo del analista. Toma nota la audiencia. Al pulsar Control ms I en la vista de consultas, invocas a Copilot al instante para trabajar directamente sobre el cdigo DAX. Pero lo importante no es que escriba la frmula, sino cmo te la presenta, utilizando lo que se conoce como la vista de diferencias o diff view. Y cmo funciona esa vista exactamente? Qu es lo que ve el usuario en la pantalla? No te cambia el cdigo de golpe, que sera un caos. La pantalla se divide o utiliza un sombreado de fondo muy visual. En verde o resaltado te muestra exactamente qu lneas de cdigo nuevas est sugiriendo y tachadas las que propone eliminar. Qu bien pensado. Es una interfaz diseada deliberadamente para obligarte a auditar el cdigo. Te fuerza a leer la lgica que propone y a tomar una decisin consciente. Tienes que aceptar o rechazar. Exacto. Debes hacer clic activamente en conservar consulta para integrarla o rechazarla si ves que, por ejemplo, la condicin de tiempo es errnea. Es la prueba definitiva de que eres el editor, no un simple espectador que mira la pantalla. Me parece supertil, sobre todo porque escribir frmulas a veces da unos dolores de cabeza tremendos. De hecho, a veces veo informes de compaeros donde se supone que debera haber un clculo complejo y de repente la tabla devuelve espacios en blanco en todas partes. S, un clsico. [risas] O peor an, repite exactamente el mismo milln de euros en todas y cada una de las filas de los productos. Por qu pasa eso y cmo ayuda la IA a salir de ese atasco? Ese error clsico del que hablas, el nmero que se repite idntico en todas las filas, suele ser un problema de contexto de filtro. Contexto de filtro. Bsicamente, significa que las relaciones entre las distintas tablas del modelo de datos estn mal configuradas o que la frmula no sabe cmo filtrar la cantidad total por cada producto individual, as que simplemente muestra el gran total del milln de euros en todas partes. Un horror. Antes, resolver esto requera horas y horas buceando en foros de Internet. Ahora puedes seleccionar ese cdigo DAX rebelde y pedirle a Copilot: \"Explcame esta consulta lnea por lnea y dime por qu el filtro no funciona\". Y es capaz de diagnosticar el problema real? A menudo s, y muy bien. Desglosa la funcin y te seala de manera superdidctica dnde se est rompiendo el flujo de los datos. Es un tutor privado excelente. Qu pasada. Sin embargo, hay un matiz importante aqu y es el estado de la arquitectura subyacente de la que hablbamos antes al simplificar el esquema. Claro, la estructura del modelo original. Escucho mucho la diferencia entre tener un esquema en estrella o trabajar con tablas planas. Para quienes no sean arquitectos de datos, qu impacto tiene esto en las famosas alucinaciones de la IA? Pues un impacto total y absoluto. Un esquema en estrella es la forma ptima de organizar la informacin. Vale. Imagina una estrella de verdad. En el centro tienes tu tabla principal, los hechos reales, como todas las ventas registradas. Y en las puntas de la estrella tienes las dimensiones, que son las categoras que dan contexto a esas ventas. Entiendo. Una punta es el calendario, otra punta es el catlogo de productos, otras son las tiendas. Todo est separado, limpio y conectado al centro. Si conectas Copilot a una estrella bien hecha, la IA se convierte en un asistente superdotado porque el terreno est ordenado. Y la alternativa de la tabla plana? La tabla plana es meter absolutamente todo en una sola hoja de clculo kilomtrica. El nombre del cliente, su edad, el producto, el color, la fecha, el precio, el coste. Un monstruo. Todo en cien columnas y millones de filas. Hay muchsima redundancia de datos. Si conectas la IA a modelos inflados y mal diseados como ese, Copilot sencillamente colapsa y se desorienta. Y ah es donde alucina. Empieza a generar cdigo ineficiente y a cruzar conceptos errneos. Auditar el cdigo DAX no significa solo leer la frmula final que escupe la mquina. Significa garantizar primero que los cimientos arquitectnicos sobre los que se apoya la IA son slidos como una roca. Es el viejo principio de la informtica: basura entra, basura sale. Tal cual. Solo que ahora con la inteligencia artificial la basura sale a la velocidad de la luz y con un formato visual precioso que resulta mucho ms convincente y francamente peligroso. No prestamos la atencin debida. Bien, pues hemos cubierto un terreno impresionante hoy en nuestra inmersin. Si hacemos un repaso rpido de todo este viaje, el mensaje central es que para alcanzar ese ansiado nivel de hero en el anlisis, debemos aceptar la evolucin inminente de nuestro rol profesional. Sin duda. Hay que dejar atrs la pasividad para abrazar por completo el papel de editor experto. Esto exige auditar exhaustivamente el cdigo usando herramientas como la vista de diferencias, crear prompts detallados que incorporen todo el contexto de negocio y sinnimos, establecer reglas y respuestas verificadas. Y simplificar los modelos. Exacto. Y fundamentalmente, ser muy conscientes de los lmites tcnicos y de filas a los que nos enfrentamos antes de que herramientas antiguas se apaguen por completo en ese temido diciembre de 2026. Esto plantea una pregunta importante a nivel organizativo y estructural en las empresas. Esta simbiosis entre el razonamiento crtico humano y la capacidad generativa de la inteligencia artificial est democratizando el anlisis a una escala sin precedentes. Totalmente. Profesionales con perfiles mucho menos tcnicos, que antes dependan cien por cien de un departamento de ingeniera, ahora pueden extraer un valor enorme de los datos por s mismos. Pero la irona de todo esto es que esta misma libertad hace que la gobernanza de datos centralizada, la limpieza extrema de los modelos y la estandarizacin estricta de las reglas de negocio sean ms vitales que en toda la historia de la informtica. Es una gran irona, s. Sin una disciplina de fondo impecable, la democratizacin se convierte rpidamente en anarqua. Totalmente de acuerdo. La base lo es absolutamente todo. Y para ir cerrando y dejar a la audiencia con una idea para reflexionar tras este anlisis a fondo, imaginemos el panorama que se dibuja en el horizonte a medida que nos acercamos a ese cierre de ciclo en 2026. A ver. Si la inteligencia artificial, que no deja de mejorar mes a mes, democratiza tanto el acceso a los datos complejos y permite a cualquier director financiero o de marketing obtener respuestas complejas directamente hablando con su ordenador, qu ocurrir con las fronteras de los departamentos tradicionales? Es una gran pregunta. Es decir, si el equipo financiero ya no necesita hacer peticiones tcnicas para obtener sus cuadros de mando, terminarn los departamentos de negocio absorbiendo por completo a los departamentos de datos? Interesante. Haciendo que el rol del analista tcnico tradicional desaparezca o se fusione irremediablemente con el estratega de negocio. Es un debate fascinante sobre el futuro del empleo en la era de la IA generativa. Gracias a todos y todas por acompaarnos en esta inmersin. Hasta el prximo anlisis a fondo"
        },
        {
            "type": "image",
